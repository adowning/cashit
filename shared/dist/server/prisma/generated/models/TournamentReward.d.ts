...
export type GetTournamentRewardAggregateType<T extends TournamentRewardAggregateArgs> = {
    [P in keyof T & keyof AggregateTournamentReward]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateTournamentReward[P]> : Prisma.GetScalarType<T[P], AggregateTournamentReward[P]>;
};
...
type GetTournamentRewardGroupByPayload<T extends TournamentRewardGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<TournamentRewardGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof TournamentRewardGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], TournamentRewardGroupByOutputType[P]> : Prisma.GetScalarType<T[P], TournamentRewardGroupByOutputType[P]>;
}>>;
...
export type TournamentRewardCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<TournamentRewardFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TournamentRewardDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['TournamentReward'];
        meta: {
            name: 'TournamentReward';
        };
    };
     ...
     * })
    **/
    count<T extends TournamentRewardCountArgs>(args?: Prisma.Subset<T, TournamentRewardCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], TournamentRewardCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends TournamentRewardGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, TournamentRewardGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTournamentRewardGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
