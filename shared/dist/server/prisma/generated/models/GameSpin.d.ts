...
export type GetGameSpinAggregateType<T extends GameSpinAggregateArgs> = {
    [P in keyof T & keyof AggregateGameSpin]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateGameSpin[P]> : Prisma.GetScalarType<T[P], AggregateGameSpin[P]>;
};
...
type GetGameSpinGroupByPayload<T extends GameSpinGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<GameSpinGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof GameSpinGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], GameSpinGroupByOutputType[P]> : Prisma.GetScalarType<T[P], GameSpinGroupByOutputType[P]>;
}>>;
...
export type GameSpinCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<GameSpinFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GameSpinDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['GameSpin'];
        meta: {
            name: 'GameSpin';
        };
    };
     ...
     * })
    **/
    count<T extends GameSpinCountArgs>(args?: Prisma.Subset<T, GameSpinCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], GameSpinCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends GameSpinGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, GameSpinGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGameSpinGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
