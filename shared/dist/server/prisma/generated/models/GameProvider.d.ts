...
export type GetGameProviderAggregateType<T extends GameProviderAggregateArgs> = {
    [P in keyof T & keyof AggregateGameProvider]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateGameProvider[P]> : Prisma.GetScalarType<T[P], AggregateGameProvider[P]>;
};
...
type GetGameProviderGroupByPayload<T extends GameProviderGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<GameProviderGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof GameProviderGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], GameProviderGroupByOutputType[P]> : Prisma.GetScalarType<T[P], GameProviderGroupByOutputType[P]>;
}>>;
...
export type GameProviderCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<GameProviderFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GameProviderDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['GameProvider'];
        meta: {
            name: 'GameProvider';
        };
    };
     ...
     * })
    **/
    count<T extends GameProviderCountArgs>(args?: Prisma.Subset<T, GameProviderCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], GameProviderCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends GameProviderGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, GameProviderGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGameProviderGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
