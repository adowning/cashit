...
export type GetOperatorInvitationAggregateType<T extends OperatorInvitationAggregateArgs> = {
    [P in keyof T & keyof AggregateOperatorInvitation]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateOperatorInvitation[P]> : Prisma.GetScalarType<T[P], AggregateOperatorInvitation[P]>;
};
...
type GetOperatorInvitationGroupByPayload<T extends OperatorInvitationGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<OperatorInvitationGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof OperatorInvitationGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], OperatorInvitationGroupByOutputType[P]> : Prisma.GetScalarType<T[P], OperatorInvitationGroupByOutputType[P]>;
}>>;
export type OperatorInvitationWhereInput = {
    ...
    invitedUser?: Prisma.XOR<Prisma.UserProfileNullableScalarRelationFilter, Prisma.UserProfileWhereInput> | null;
};
...
export type OperatorInvitationUpdateInput = {
    ...
    invitedUser?: Prisma.UserProfileUpdateOneWithoutOperatorInvitationsNestedInput;
};
...
export type OperatorInvitationSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
    ...
    invitedUser?: boolean | Prisma.OperatorInvitation$invitedUserArgs<ExtArgs>;
...
export type $OperatorInvitationPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    ...
    objects: {
        ...
        invitedUser: Prisma.$UserProfilePayload<ExtArgs> | null;
    };
...
export type OperatorInvitationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<OperatorInvitationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OperatorInvitationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['OperatorInvitation'];
        meta: {
            name: 'OperatorInvitation';
        };
    };
     ...
     * })
    **/
    count<T extends OperatorInvitationCountArgs>(args?: Prisma.Subset<T, OperatorInvitationCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], OperatorInvitationCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends OperatorInvitationGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, OperatorInvitationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOperatorInvitationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface Prisma__OperatorInvitationClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    invitedUser<T extends Prisma.OperatorInvitation$invitedUserArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.OperatorInvitation$invitedUserArgs<ExtArgs>>): Prisma.Prisma__UserProfileClient<runtime.Types.Result.GetResult<Prisma.$UserProfilePayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>;
    /**
...
/**
 * OperatorInvitation.invitedUser
 */
export type OperatorInvitation$invitedUserArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
