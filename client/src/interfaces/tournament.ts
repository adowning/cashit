...
import type {
  PrismaTournament as PrismaTournament,
  PrismaTournamentReward as PrismaTournamentReward,
  PrismaTournamentGame as PrismaTournamentGame,
  PrismaGame as PrismaGame,
  PrismaUser as PrismaUser,
