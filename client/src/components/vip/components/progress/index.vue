<script lang="ts" setup>
  ...
  import { useI18n } from 'vue-i18n.vue'
  import { storeToRefs } from 'pinia'
  import { vipStore } from '@/store/vip.vue'
  ...
  import { bonusTransactionStore } from '@/store/bonusTransaction.vue'
  import { refferalStore } from '@/store/refferal.vue'
