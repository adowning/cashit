...
<script setup>
  import BattlesFilterMode from '@/components/battles/BattlesFilterMode.vue'
  import { ref, computed } from 'vue'

  // Data
  const battlesLevel = ref(0)
  const battlesFunding = ref(0)

  // Computed

  // Methods
  const battlesTypeButton = function (value) {
    this.battlesSetFilterType(value)
  }

  // Created
  battlesLevel.value = this.battlesFilterLevel
  battlesFunding.value = this.battlesFilterFunding
</script>
