  ...
  >
    ...
    <div class="mode-menu">
      <div class="menu-inner">
        ...
        <button v-if="battlesFilterType === 'standard'" v-on:click="battlesModeButton('2v2')">
          2v2
        </button>
      </div>
    </div>
...
<script setup>
  ...
  // Data
  const battlesDropdown = ref(false)

  // Computed

  // Methods
  const battlesToggleDropdown = function () {
    battlesDropdown.value = !battlesDropdown.value
  }

  const battlesModeButton = function (value) {
