        ...
        <div class="amount-container">
          <div class="container-inner">
            ...
            <div class="inner-value">
              <span>{{ battlesFormatValue(battlesGetAmountTotal).split('.')[0] }}</span
              >.{{ battlesFormatValue(battlesGetAmountTotal).split('.')[1] }}
            </div>
          </div>
        </div>
      </div>
...
<script setup>
  import BattlesFilterSort from '@/components/battles/BattlesFilterSort.vue'
  import { computed } from 'vue'

  // Computed
  const battlesGetAmountTotal = computed(() => {
    let amount = 0
