<template>
  <div class="battles-create-footer">
    <div class="footer-left">
      ...
      <div
        v-if="battlesFilterPrivate === true"
        class="left-affiliate"
        v-bind:class="{ 'affiliate-active': battlesFilterAffiliate === true }"
      >
        AFFILIATES ONLY
    ...
    <div class="footer-right">
      ...
      <div
        ...
        v-bind:class="{ 'terminal-active': battlesFilterTerminal === true }"
      >
...
<script setup>
  ...
  // Methods
  const battlesPrivateToggle = function () {
    if (this.battlesFilterPrivate === true) {
      this.battlesSetFilterAffiliate(false)
    }
    this.battlesSetFilterPrivate(!this.battlesFilterPrivate)
  }

  const battlesCursedToggle = function (value) {
  ...
  const battlesTerminalToggle = function (value) {
