...
<script setup>
  ...
  // Computed
  const battlesSelectedCount = computed(() => {
    return this.battlesSelected.filter((element) => element._id === props.box._id).length
  })
  ...
  const battlesAddButton = function () {
    this.battlesAddSelected(props.box)
  }

  const battlesIncreaseButton = function () {
    this.battlesAddSelected(props.box)
  }

  const battlesDecreaseButton = function () {
    this.battlesRemoveSelected(props.box)
  }
</script>
